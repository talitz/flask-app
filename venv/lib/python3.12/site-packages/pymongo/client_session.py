...
causally consistent session, an app can read its own writes and is
...
class ClientSession:
    ...
    Should not be initialized directly by app developers - to create a
    ...
    def with_transaction(
        ...
        modifies app state or has any other side-effects.
