...
class PoolOptions:
    ...
    Should not be instantiated directly by app developers. Access
    ...
    def __init__(
        ...
        if appname:
            self.__metadata["app"] = {"name": appname}
    ...
    def appname(self) -> Optional[str]:
        """The app name, for sending with hello in server handshake."""
    ...
    def metadata(self) -> dict[str, Any]:
        """A dict of metadata about the app, driver, os, and platform."""
