    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :param datetime_conversion: Specifies how UTC datetimes should be decoded
          ...
          - `appname`: (string or None) The name of the app that
          ...
          - `tlsAllowInvalidCertificates`: (boolean) If ``True``, continues
            ...
            to ``True`` as that could make your app vulnerable to
            on-path attackers.
          - `tlsAllowInvalidHostnames`: (boolean) If ``True``, disables TLS
            ...
            setting this to ``True`` as that could make your app
    ...
    def run(self) -> T:
        ...
        while True:
            ...
            try:
                ...
                # The app may think the write was never attempted
