...
class ApplicationCommunicator:
    """
    Runs an ASGI app in a test mode, allowing sending of
    ...
    def __init__(self, application, scope):
        ...
        # are not "leaked" into the app which would normally begin with
    ...
    async def wait(self, timeout=1):
        """
        Waits for the app to stop itself and returns any exceptions.
        """
        try:
    ...
    async def send_input(self, message):
        """
        Sends a single message to the app
        """
        # Give it the message
    ...
    async def receive_output(self, timeout=1):
        """
        Receives a single message from the app, with optional timeout.
        """
