...
class GridFS:
    ...
    def exists(
        ...
        **kwargs: Any,
        ...
        create appropriate indexes; app developers should be
...
class GridFSBucket:
    ...
    def open_upload_stream(
        ...
        """Opens a Stream that the app can write the contents of the
        file to.
    ...
    def open_download_stream(
        ...
        """Opens a Stream from which the app can read the contents of
