...
def parse_mime_type(mime_type):
    ...
    For example, the media range 'app/xhtml;q=0.5' would get parsed
    into:
...
def parse_media_range(range):
    ...
    range.  For example, the media range 'app/*;q=0.5' would get parsed
    into:
...
def best_match(supported, header):
    ...
    >>> best_match(['app/xbel+xml', 'text/xml'],
                   'text/*;q=0.5,*/*; q=0.1')
    'text/xml'
