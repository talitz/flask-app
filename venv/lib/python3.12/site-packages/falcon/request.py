...
class Request:
    ...
    Attributes:
        ...
        forwarded_host (str): Original host request header as received
            by the first proxy in front of the app server.
        ...
        root_path (str): The initial portion of the request URI's path that
            corresponds to the app object, so that the
            app knows its virtual "location". This may be an
            empty string, if the app corresponds to the "root"
            of the server.
        ...
        remote_addr(str): IP address of the closest client or proxy to
            ...
            Note:
                If your app is behind one or more reverse
        ...
        stream: File-like input object for reading the body of the
            ...
            flexibility to the app, Falcon itself does not
            ...
            Note:
                ...
                *app/x-www-form-urlencoded* media type, and
    ...
    def __init__(self, env, options=None):
        ...
        if (
            ...
            and 'app/x-www-form-urlencoded' in self.content_type
            and
    ...
    def client_accepts_json(self):
        return self.client_accepts('app/json')

    @property
    def client_accepts_msgpack(self):
        return self.client_accepts('app/x-msgpack') or self.client_accepts(
            'app/msgpack'
        )

    @property
    def client_accepts_xml(self):
        return self.client_accepts('app/xml')
    ...
    def get_param(self, name, required=False, store=None, default=None):
        ...
        Note:
            If an HTML form is POSTed to the API using the
            *app/x-www-form-urlencoded* media type, Falcon can
    ...
    def _parse_form_urlencoded(self):
        ...
        try:
            ...
            self.log_error(
                ...
                'app/x-www-form-urlencoded. Body '
                'will be ignored.'
            )
...
class RequestOptions:
    ...
    Attributes:
        ...
        auto_parse_form_urlencoded: Set to ``True`` in order to
            ...
            *app/x-www-form-urlencoded* (default ``False``).
        ...
        strip_url_path_trailing_slash: Set to ``True`` in order to
            ...
            character. This lets the app define a single route
        ...
        media_handlers (Handlers): A dict-like object for configuring the
            ...
            ``app/json``, ``app/x-www-form-urlencoded`` and
