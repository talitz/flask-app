...
def inspect_app(app: App) -> 'AppInfo':
    ...
    Args:
        app (falcon.App): The app to inspect. Works with both
            :class:`falcon.App` and :class:`falcon.asgi.App`.

    Returns:
        AppInfo: The information regarding the app. Call
...
def inspect_routes(app: App) -> 'List[RouteInfo]':
    ...
    Returns:
        List[RouteInfo]: A list of route descriptions for the app.
    """
    router = app._router
    ...
    if inspect_function is None:
        raise TypeError(
            ...
            'used by the provided app'.format(type(router))
        )
...
def register_router(router_class):
    ...
    app and returns a list of :class:`.RouteInfo`. Eg::
...
def inspect_static_routes(app: App) -> 'List[StaticRouteInfo]':
    """Inspects the static routes of an app.
...
def inspect_sinks(app: App) -> 'List[SinkInfo]':
    ...
    Returns:
        List[SinkInfo]: A list of sinks used by the app.
    """
    sinks = []
...
def inspect_error_handlers(app: App) -> 'List[ErrorHandlerInfo]':
    """Inspects the error handlers of an app.
...
def inspect_middleware(app: App) -> 'MiddlewareInfo':
    """Inspects the middleware components of an app.
...
class AppInfo(_Traversable):
    ...
    Args:
        routes (List[RouteInfo]): The routes of the app.
        middleware (MiddlewareInfo): The middleware information in the app.
        static_routes (List[StaticRouteInfo]): The static routes of this app.
        sinks (List[SinkInfo]): The sinks of this app.
        error_handlers (List[ErrorHandlerInfo]): The error handlers of this app.
        asgi (bool): Whether or not this is an ASGI app.
    """
    ...
    def to_string(self, verbose=False, internal=False, name='') -> str:
        ...
        Args:
            ...
            name (str, optional): The name of the app, to be output at the
                beginning of the text. Defaults to ``'Falcon App'``.
        Returns:
            str: A string representation of the app.
        """
