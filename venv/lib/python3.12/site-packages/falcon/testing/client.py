...
def simulate_request(
    ...
    """Simulate a request to a WSGI or ASGI app.

    Performs a request against a WSGI or ASGI app. In the case of
    ...
    Keyword Args:
        app (callable): The WSGI or ASGI app to call
        ...
        root_path (str): The initial portion of the request URL's "path" that
            corresponds to the app object, so that the app
            knows its virtual "location". This defaults to the empty string,
            indicating that the app corresponds to the "root" of the
            server.
        ...
        json(JSON serializable): A JSON document to serialize as the
            ...
            ``'app/json'``, overriding any value specified by either
...
async def _simulate_request_asgi(
    ...
    """Simulate a request to an ASGI app.
...
class ASGIConductor:
    ...
    Args:
        app (callable): An ASGI app to target when simulating
            requests.
    ...
    async def simulate_get(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a GET request to an ASGI app.
    ...
    def simulate_get_stream(self, path='/', **kwargs):
        """Simulate a GET request to an ASGI app with a streamed response.
    ...
    def simulate_ws(self, path='/', **kwargs):
        """Simulate a WebSocket connection to an ASGI app.
    ...
    async def simulate_head(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a HEAD request to an ASGI app.
    ...
    async def simulate_post(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a POST request to an ASGI app.
    ...
    async def simulate_put(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a PUT request to an ASGI app.
    ...
    async def simulate_options(self, path='/', **kwargs) -> _ResultBase:
        """Simulate an OPTIONS request to an ASGI app.
    ...
    async def simulate_patch(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a PATCH request to an ASGI app.
    ...
    async def simulate_delete(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a DELETE request to an ASGI app.
...
def simulate_get(app, path, **kwargs) -> _ResultBase:
    """Simulate a GET request to a WSGI or ASGI app.
...
def simulate_head(app, path, **kwargs) -> _ResultBase:
    """Simulate a HEAD request to a WSGI or ASGI app.
...
def simulate_post(app, path, **kwargs) -> _ResultBase:
    """Simulate a POST request to a WSGI or ASGI app.
...
def simulate_put(app, path, **kwargs) -> _ResultBase:
    """Simulate a PUT request to a WSGI or ASGI app.
...
def simulate_options(app, path, **kwargs) -> _ResultBase:
    """Simulate an OPTIONS request to a WSGI or ASGI app.
...
def simulate_patch(app, path, **kwargs) -> _ResultBase:
    """Simulate a PATCH request to a WSGI or ASGI app.
...
def simulate_delete(app, path, **kwargs) -> _ResultBase:
    """Simulate a DELETE request to a WSGI or ASGI app.
...
class TestClient:
    """Simulate requests to a WSGI or ASGI app.
    ...
    Args:
        app (callable): A WSGI or ASGI app to target when simulating
            requests
    ...
    def simulate_get(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a GET request to a WSGI app.
    ...
    def simulate_head(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a HEAD request to a WSGI app.
    ...
    def simulate_post(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a POST request to a WSGI app.
    ...
    def simulate_put(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a PUT request to a WSGI app.
    ...
    def simulate_options(self, path='/', **kwargs) -> _ResultBase:
        """Simulate an OPTIONS request to a WSGI app.
    ...
    def simulate_patch(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a PATCH request to a WSGI app.
    ...
    def simulate_delete(self, path='/', **kwargs) -> _ResultBase:
        """Simulate a DELETE request to a WSGI app.
    ...
    def simulate_request(self, *args, **kwargs) -> _ResultBase:
        """Simulate a request to a WSGI app.
