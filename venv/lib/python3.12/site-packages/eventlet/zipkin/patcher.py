...
def enable_trace_patch(host='127.0.0.1', port=9410,
    ...
    """ Apply monkey patch to trace your WSGI app.
    ...
    :param trace_app_log: A Boolean indicating if the tracer will trace
        app log together or not. This facility assume that
        your app uses python standard logging library.
        (default: False)
    ...
    # monkey patch for capturing app log
    if trace_app_log:
        log.patch()
